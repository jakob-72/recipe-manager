...
class RecipeServiceTest :
    StringSpec({
        ...
        "when findRecipesByIngredient is called with a valid ingredient name, then it should return matching recipes" {
            // given
        ...
        "when findRecipesByIngredient is called with an unused ingredient name, then it should return an empty list" {
            // given
        ...
        "when updateRecipe is called with a valid id and updated recipe data, then it should update and return the recipe" {
            // given
            val id = TestData.testRecipe.id.toString()
